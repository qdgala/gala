...
class Report(osv.Model):
    ...
    def get_pdf(self, cr, uid, ids, report_name, html=None, data=None, context=None):
        ...
        qwebtypes=[]
        if context.get('converter'):
            if context['converter']=='pdf':
                qwebtypes.append('qweb-pdf')
            if context['converter']=='html':
                qwebtypes.append('qweb-html')


        # Get the ir.actions.report.xml record we are working on.
        report = self._get_report_from_name(cr, uid, report_name,qwebtypes)
    ...
    def _get_report_from_name(self, cr, uid, report_name,qwebtypes=[]):
