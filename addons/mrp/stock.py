...
class StockMove(osv.osv):
    ...
    _columns = {
        ...
        #qxs
        'xshth':fields.related('production_id','xshth',string=u"销售合同号",type="char",store = False),
        ...
        'mrp_stock_queren': fields.selection([('draft',u'生产提交'),('queren',u'仓库确认'),('done',u'完成')],u'生产调拨仓库确认', readonly = True,copy=False),
    }
    _defaults = {
        'mrp_stock_queren': 'draft',
    }
    ...
    def action_consume(self, cr, uid, ids, product_qty, location_id=False, restrict_lot_id=False, restrict_partner_id=False,
        ...
        #qxs
        self.write(cr, uid, ids2, {'mrp_stock_queren': 'queren'}, context=context)
        #qxs
    ...
    def qxs_action_done(self,cr, uid, ids, context=None):
        self.write(cr, uid, ids, {'mrp_stock_queren': 'done'}, context=context)
        res = self.action_done(cr, uid, ids, context=context)
        return res
